...
export const DEFAULT_POOL_CONFIGS = [
  {
    'id': 'bf004d83-0e2c-47a0-b18e-b5522dc6f256',
    'name': '默认配置',
    'entries': [
      {
        'entry_id': '06281157-6887-483e-b9e8-a00f1f2f646e\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '46f40348-1295-4590-bf13-20148f1a6878\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'ac7a380e-0fc8-4a8e-9cb3-708a65a262bc\r',
        'pinned': true,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'd7b1c9b6-b4e6-4142-bece-d8a60891674a\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '184ab76e-eff4-4077-92d5-a5546334156d\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '723b408e-8bf3-49a5-bef9-b1bc00bd841e\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '1e873462-c053-4ada-a15b-88ffcb3a9281\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '44e3e679-b7df-4c69-8ffb-f9e73e5d706a\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '00d078ed-f187-4e96-af8e-75b8bf0a0653\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '4cd6cf68-d8e1-4914-8ee1-9013b443a21c\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '244fae0b-b392-4a82-a074-159f1385d80d\r',
        'pinned': false,
        'weight': 1,
        'condition': '双方关系已有暧昧张力或好感基础'
      },
      {
        'entry_id': '41727a9d-360b-46ea-a7ce-a4e84d1f32b5\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '2e82721d-0214-4275-9668-5a2581413a1c\r',
        'pinned': false,
        'weight': 1,
        'condition': '双方已建立足够信任，且当前氛围私密安全'
      },
      {
        'entry_id': '49a7b08d-bf09-41da-8546-97c9d79bc8c0\r',
        'pinned': false,
        'weight': 1,
        'condition': '对方存在明显的不安或顾虑，需要确定感'
      },
      {
        'entry_id': 'ddaac18b-bd46-495e-b151-a6b6e01c8d6a\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '4484b7b6-2821-4754-b747-5adf5dcac9a4\r',
        'pinned': false,
        'weight': 1,
        'condition': '双方关系已到临界点，再进一步或彻底错过'
      },
      {
        'entry_id': '978a0b7c-b0b8-417e-950b-ec6af837885a\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'dc6a7605-07a9-44f5-8e6a-02cdd0b51b31\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'cc75f877-77c5-441c-9920-8e1154886f54\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '57a69ff3-cf96-4296-9c49-e333d58e9a0f\r',
        'pinned': false,
        'weight': 1,
        'condition': '场景中除主要互动对象外还有其他人在场'
      },
      {
        'entry_id': '965bf4b0-3460-48ff-9490-be7bbbfa3dc0\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'd89e6439-75db-4825-9ce5-1a9bacd3b4d3\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '3150bca0-167f-4940-b1db-eb7c2b4bb3ae\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '9b7e2f6c-0eba-4f3b-aea4-df3da5f7550d\r',
        'pinned': false,
        'weight': 1,
        'condition': '场景中存在未被解释的疑点或线索'
      },
      {
        'entry_id': '959c288c-1c3e-4c13-9b8c-2f8a86fc4abe\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '6a362775-f9b4-4505-9f06-76ea5e8769d4\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'a9fca7c6-483b-4b01-ab14-a263b479eac5\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '1d41e1f2-97f0-4df4-9bb0-df70a3e207d7\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'ab5a0747-af8a-4a81-8f66-5dfe01c42d95\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '03b44d45-699f-4fa4-a8ab-08433349f719\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'a1c8dd69-932f-44dd-b12d-f5229b717acf\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '9302679d-6659-471e-a5bd-bb7c312ae984\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '992fee46-7bff-474c-be32-72d486554a36\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '19972820-8a7b-4bd6-8c89-ac203ec98dfd\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '904f43eb-a931-49f1-940b-e336d44a758d\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '151e3652-6ec2-4504-ac20-be761454e244\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '2301ee04-8f95-4ae1-8acc-371126dd6782\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'adc2e8e3-183b-4d2b-947d-93f4f91d6efa\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '07368053-fd05-4de2-abb7-68d773a3ec6e\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '4eff7291-0037-495c-bab0-b46adb72b183\r',
        'pinned': false,
        'weight': 1,
        'condition': '场景中存在真实矛盾或立场对立，而非日常闲聊'
      },
      {
        'entry_id': '6319000e-37ab-4519-9061-f3d44da66fea\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '3c18bbe8-5b3e-4041-9495-9e12867063a0\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '1f6d087a-0c28-429c-ab49-fabe90e88566\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '3da59b71-4f2e-4882-bede-620f16db0890\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'd9ea7a95-2d00-426a-98b1-3286332037a0\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '824d18ee-c236-46a6-93ee-9050f68087a1\r',
        'pinned': false,
        'weight': 1,
        'condition': '双方之间存在尚未愈合的嫌隙或误会'
      },
      {
        'entry_id': 'eb3fbe40-2ae7-449c-aaf7-eca8c92bf0b8\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'b721a677-a5e4-42aa-ae65-15f404bac99a\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '48d05b30-19d6-4324-9bca-9f047d954c36\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': '0a3736e9-ef34-4175-88ee-19452b24fe98\r',
        'pinned': false,
        'weight': 1,
        'condition': '剧情中确实存在尚未揭破的残酷事实'
      },
      {
        'entry_id': '5b43b091-ee0c-4d7f-9406-63de7af2d2e4\r',
        'pinned': false,
        'weight': 1,
        'condition': ''
      },
      {
        'entry_id': 'a0c02176-a289-4f06-afaf-865308ce86d0\r',
        'pinned': false,
        'weight': 1,
